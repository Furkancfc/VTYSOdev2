...
class Action
{
	...
	{
		extract($_POST);
		$d1 = $this->db->query("DELETE FROM project_list where id = $id");
		$d2 = $this->db->query("DELETE FROM task_list where project_id=$id");
		$d3 = $this->db->query("DELETE FROM user_productivity where project_id = $id");
		if ($d1 && $d2 && $d3) {
			return 1;
		}
		else{
	...
	function delete_task()
	{
		extract($_POST);
		error_log("test");
		$d1 = $this->db->query("DELETE FROM task_list where id = $id");
		$d2 = $this->db->query("DELETE FROM user_productivity where task_id = $id ");
		if ($d1 && $d2) {
			return 1;
		}
		else{
