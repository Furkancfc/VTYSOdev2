			...
			<form action="" id="manage_user">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">Soy İsim</label>
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								<option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Çalışan
								</option>
								<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Proje
									Yöneticisi</option>
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button"
						onclick="location.href = 'index.php?page=user_list'">Reddet</button>
				</div>
			</form>
		</div>
	</div>
